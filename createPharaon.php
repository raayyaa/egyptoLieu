...
<body>
  ...
  <h1>Formulaire d'ajout Pharaon</h1>

  <form method="post" action="/egyptoLieu/controllerPharaon/create" enctype="multipart/form-data">

    <p>Nom du Pharaon <input class="modif" name="id" id="id" type="text" value=""></p>
    <p>Comment Pharaon <textarea class="modif" name="commentPh" id="commentPh" type="text"></textarea></p>
