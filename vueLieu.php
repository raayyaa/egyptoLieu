...
<br><br><br>
  ...
  <a class='button' href='createLieu.php'>Nouveau</a>
  ...
  <div class="container">
    ...
    foreach ($datarecup as $donnees) {
      ...
      echo "<p class='title' name='id'>" . $donnees['NomLieu'] . "</p>";
      echo "<p class='description' name='description'>" . $donnees['description'] . "</p>";
      echo "<a class='button' href='Lieu/" . $donnees['NomLieu'] . "/modifier'>Modifier</a>";
      echo "&nbsp";
      echo "<a class='button' href='Lieu/" . $donnees['NomLieu'] . "/delete'>Supprimer</a>";
      echo "</div>";
      echo "</div>";
    }
